...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 617.5, 37.0, 496.0, 542.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 20.0, 423.0, 223.0, 22.0 ],
...
,
					"text" : "node.script koral-server.cjs @autostart 1"
				}
...
, 			{
				"name" : "koral-server.cjs",
				"bootpath" : "~/work/dev/projects/koral/instruments/max-build",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
