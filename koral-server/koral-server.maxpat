...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 206.0, 355.0, 83.0, 22.0 ],
					"text" : "script running"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 206.0, 316.0, 126.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 575.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 254.0, 531.0, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 617.5, 37.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 518.0, 117.0, 22.0 ],
...
,
					"text" : "node.script koral-server.js @autostart 1 @watch 1",
					"textfile" : 					{
						"filename" : "koral-server.js",
						"flags" : 0,
						"embed" : 0,
						"autowatch" : 1
					}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 319.5, 496.0, 570.25, 496.0, 570.25, 41.0, 627.0, 41.0 ],
					"source" : [ "obj-1", 1 ]
				}
